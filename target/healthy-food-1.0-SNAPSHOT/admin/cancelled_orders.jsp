    ...
    <body>
        ...
        <section id="mes">
            ...
            <div class="message">
                ...
                <div>
                    <h1 class="red">Cancelled Orders</h1>
                </div>
            </div>
        </section>
            ...
            <table width="100%">
                ...
                <%
                    ...
                    try{
                        ...
                        ResultSet rs = st.executeQuery("select * from cart inner join product where cart.product_id=product.id and cart.order_date is not NULL and cart.status='Cancel'");
                        while(rs.next()){
